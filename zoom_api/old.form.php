...
<body>
    ...
    <p style="font-size:16px;">Important:<br>Hold Control key/Command key[for Mac] while clicking on both buttons. If on mobile device, open buttons in new tab. </p>
    <br>
    ...
    <button target="_blank" id="sas1" type="submit" formaction="https://mynotarydoc.com/zoom_login/dashboard/form_process.php" style="float:right;">
			Confirm inputs
		</button>
