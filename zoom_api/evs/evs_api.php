...
<div class='form_main'>
    ...
    <form action='/zoom_api/evs/respon.php' method='post'>
...
echo "
<div class='form_main'>
    <form action='/zoom_api/evs/respon.php' method='post' id='fForm'>
         <br><br><div>
         <h1>Authentication Questions</h1>
      </div><br><br>
...
{
  header("Location: https://mynotarydoc.com/zoom_api/evs/redirect2.php");      
}
